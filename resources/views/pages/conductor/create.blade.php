@extends('layouts.app', ['activePage' => 'conductor', 'titlePage' => __('Nuevo Conductor')])
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title"><b>Conductores</b> </h4>
                            <p class="card-category"> Crear Conductores Para el Sistema</p>
                        </div>
                        <div class="card-body">
                            <H4><b><i class="fa fa-id-card"></i> Datos Personales</b></H4>
                            <hr>
                            <form action="{{ route('conductores.store') }}" method="POST" id="formulario" class="mt-4">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div
                                            ...
                                            <input
                                                ...
                                                {{-- placeholder="{{ __('Transportadora') }}" --}} value="" />
