@extends('layouts.app', ['activePage' => 'proveedor', 'titlePage' => __('Tablero Proveedor')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ route('proveedores.create') }}" class="btn btn-success pull-right"><span
                            class="material-icons">
                            person_add</span> Nuevo Proveedor <div class="ripple-container">
                        </div>
                    </a>
                </div>
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-warning">
                            <h4 class="card-title ">Tabla Proveedor</h4>
                            <p class="card-category"> Listado de Proveedores del sistema</p>
                        </div>
                        <div class="card-body">
