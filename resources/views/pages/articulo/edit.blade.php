@extends('layouts.app', ['activePage' => 'articulo', 'titlePage' => __('Editar Articulo')])
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category"> Ediatr Articulo Para el Sistema</p>
                        </div>
                        <div class="card-body">

                            <form action="{{ route('articulos.update', $articulo->id) }}" method="POST" id="formulario">
                                @csrf
                                @method('PATCH')
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div
                                            ...
                                            <select name="tipo_articulo" id="tipo_articulo"
                                                ...
                                                <option value="{{ $articulo->serie_artiulo->id }}" @if (old('tipo_articulo', $articulo->serie_artiulo->descripcion_serie_articulo) == '{{ $articulo->serie_artiulo->descripcion_serie_articulo }}') {{ 'selected' }} @endif>
                                                    {{ $articulo->serie_artiulo->descripcion_serie_articulo }}</option>
                                    ...
                                    <div class="col-md-2 mt-3">
                                        <div
                                            ...
                                            <input
                                                ...
                                                value="{{ old('codigo_articulo', $articulo->codarticulo) }}" />
                                    ...
                                    <div class="col-md-10 mt-3">
                                        <div
                                            ...
                                            <input
                                                ...
                                                {{-- placeholder="{{ __('Tipo de Servicio') }}" --}}
                                                value="{{ old('descripcion_articulo', $articulo->descripcion) }}" />
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div
                                            ...
                                            <input
                                                ...
                                                {{-- placeholder="{{ __('Tipo de Servicio') }}" --}}
                                                value="{{ old('referencia_articulo', $articulo->referencia) }}" />
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div
                                            ...
                                            <input
                                                ...
                                                {{-- placeholder="{{ __('Tipo de Servicio') }}" --}}
                                                value="{{ old('medida_articulo', $articulo->medida) }}" />
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div
                                            ...
                                            <input
                                                ...
                                                {{-- placeholder="{{ __('Tipo de Servicio') }}" --}}
                                                value="{{ old('costo_articulo', $articulo->costo) }}" />
                                    ...
                                    <div class="col-md-4 mt-3">
                                        <div
                                            ...
                                            <input
                                                ...
                                                {{-- placeholder="{{ __('Tipo de Servicio') }}" --}}
                                                value="{{ old('precio_minimo', $articulo->precio_minino) }}" />
